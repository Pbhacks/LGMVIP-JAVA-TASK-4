# LGMVIP-JAVA-TASK-4
Task 4 for internship LGM VIP
A java TEXT EDITOR by Priyant;


![Alt text](https://github.com/Pbhacks/LGMVIP-JAVA-TASK-4/blob/main/1.png)
 
 USER MANUAL
-------------

DEAR USER,
THIS APP HAS BEEN MADE AS A BASIC TEXT EDITOR APPLICATION AND, HAS BEEN TESTED BY ME 
...
AND GET YOUR FILES GO THROUGH CRUD OPERATIONS AS EXPECTED.
